<template>
  <div>
    ...
    <v-contextmenu ref="contextmenu">
      <v-contextmenu-item @click="onRemove">
        {{ t('close') }}
      </v-contextmenu-item>
      <v-contextmenu-item @click="onRemoveOther">
        {{ t('closeOther') }}
      </v-contextmenu-item>
      <v-contextmenu-item @click="onRemoveAll">
        {{ t('closeAll') }}
      </v-contextmenu-item>
    </v-contextmenu>
  </div>
...
import { base, bus, storage } from '@chant/share'
import { useAppStore } from '@chant/store'
